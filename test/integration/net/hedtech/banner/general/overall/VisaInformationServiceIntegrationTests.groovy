...
class VisaInformationServiceIntegrationTests extends BaseIntegrationTestCase {
    ...
    //modifying the visa type temporarily from B1 to B2 to see if it passes.
    ...
    void testFetchAllWithMaxSeqNumByIssuingNationCodeAndPidmInList() {
        def visaInformation = newValidForCreateVisaInformationForParameterPassed("1",(new Date()-1), (new Date()+1), "B2")
