...
class PersonCredentialV8CompositeServiceIntegrationTests extends BaseIntegrationTestCase {
    ...
    @Test
    void testList_PersonsCredentials_v8() {
    ...
    @Test
    void testGet_PersonCredentials_v8() {
        setAcceptHeader("application/vnd.hedtech.integration.v8+json")
        PersonCredentialsDecorator decorator = personCredentialV8CompositeService.get(guid)
        assertNotNull decorator
    ...
    @Test
    void testGet_InvalidPersonCredentials_v8() {
        setAcceptHeader("application/vnd.hedtech.integration.v8+json")
        String guid = 'xxxxx'
        try {
