...
import com.sungardhe.banner.general.overall.SqlProcess
...
class SqlProcessIntegrationTests extends BaseIntegrationTestCase {
    ...
    protected void setUp() {
        formContext = ['GORRSQL', 'GOIRSQL'] // Since we are not testing a controller, we need to explicitly set this
        super.setUp()
