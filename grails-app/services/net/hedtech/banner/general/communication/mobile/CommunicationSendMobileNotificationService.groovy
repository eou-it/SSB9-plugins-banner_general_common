...
class CommunicationSendMobileNotificationService {
     ...
     */
    public void send( CommunicationOrganization organization, CommunicationEmailMessage emailMessage, CommunicationRecipientData recipientData ) {
        ...
        try {
            track( organization, emailMessage, recipientData )
        } catch (Throwable t) {
            log.error( t )
            throw t;
        } finally {
    ...
    private void track( CommunicationOrganization organization, CommunicationEmailMessage emailMessage, CommunicationRecipientData recipientData ) {
        ...
        emailItem.setRecipientPidm( recipientData.pidm )
