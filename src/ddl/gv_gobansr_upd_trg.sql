...
-- AUDIT TRAIL END
--
CREATE OR REPLACE TRIGGER gobansr_view_update_trg
  INSTEAD OF UPDATE ON gv_gobansr
BEGIN
  gfksjpa.setId(:OLD.gobansr_surrogate_id);
  gfksjpa.setVersion(:NEW.gobansr_version);
  gb_pin_answer.p_update
