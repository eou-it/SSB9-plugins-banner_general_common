...
-- AUDIT TRAIL END
--
CREATE OR REPLACE TRIGGER gorcmsc_view_update_trg
  INSTEAD OF UPDATE ON gv_gorcmsc
BEGIN
  gfksjpa.setId(:OLD.gorcmsc_surrogate_id);
  gfksjpa.setVersion(:NEW.gorcmsc_version);
  gb_cm_source_rules.p_update
