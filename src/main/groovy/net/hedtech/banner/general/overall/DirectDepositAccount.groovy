...
class DirectDepositAccount implements Serializable {
    ...
    static constraints = {
        ...
        hrIndicator(nullable: false, maxSize: 1)
        ...
        addressSequenceNum(nullable: true, min: 0, max: 99)
        intlAchTransactionIndicator(nullable: false, maxSize: 1)
        ...
        iatAddessSequenceNum(nullable: true, min: 0, max: 99)
    }
