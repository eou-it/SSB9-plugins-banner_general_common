...
@NamedQueries(value = [
        @NamedQuery(name = "PopulationSelectionExtract.fetchByApplicationSelectionCreatorIdLastModifiedBy",
                query = """FROM PopulationSelectionExtract a
...
class PopulationSelectionExtract implements Serializable {
    ...
    public static List fetchByApplicationSelectionCreatorIdLastModifiedBy(String application,
                                                                                  String selection,
                                                                                  String creatorId,
                                                                                  String lastModifiedBy,
                                                                                  def params = [:]) {
        ...
        if (application && selection && creatorId) {
            pidmsres = PopulationSelectionExtract.withSession
                    { session ->
                        org.hibernate.Query query = session.getNamedQuery('PopulationSelectionExtract.fetchByApplicationSelectionCreatorIdLastModifiedBy')
